...
public class AboutTab {
	...
	public JComponent build() {
		...
		JLabel lFfmpegLink = builder.addLabel(ffmpegLink.getLabel(), cc.xy(2, 7, "center, fill"));
		...
		JLabel lMplayerLink = builder.addLabel(mplayerLink.getLabel(), cc.xy(2, 9, "center, fill"));
		...
		JLabel lMplayerSubJunkBuildsLink = builder.addLabel(mplayerSubJunkBuildsLink.getLabel(), cc.xy(2, 11, "center, fill"));
		...
		JLabel lImageMagickLink = builder.addLabel(imageMagickLink.getLabel(), cc.xy(2, 13, "center, fill"));
